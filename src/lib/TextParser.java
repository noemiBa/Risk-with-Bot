...
public class TextParser {
	...
	public static PatternName [] patterns = {
			...
			new PatternName(Pattern.compile("(ALTA)|(AB)|(ALB.{0,5})", Pattern.CASE_INSENSITIVE), "Alberta"),
			new PatternName(Pattern.compile("(G.{0,4}L.{0,3})|Green", Pattern.CASE_INSENSITIVE), "Greenland"),
			new PatternName(Pattern.compile("(E\\sUnited\\sStates.{0,7})|(E\\sUS.{0,10})|(E\\sUn.{0,10}|(East\\sUS.{0,10})|(East\\sUn.{0,10}))", Pattern.CASE_INSENSITIVE), "E United States"),
			new PatternName(Pattern.compile("(W\\sUnited\\sStates.{0,7})|(W\\sUS.{0,10})|(W\\sUn.{0,10})|(West\\sUS.{0,10})|(West\\sUn.{0,10})", Pattern.CASE_INSENSITIVE), "W United States"),
			new PatternName(Pattern.compile("CE.{0,7}A.{0,6}", Pattern.CASE_INSENSITIVE), "Central America"),
			...
			new PatternName(Pattern.compile("(UK.{0,2}A.{0,3})|UKR", Pattern.CASE_INSENSITIVE), "Ukraine"),
			...
			new PatternName(Pattern.compile("Kam.{0,6}", Pattern.CASE_INSENSITIVE), "Kamchatka"),
			new PatternName(Pattern.compile("Siam", Pattern.CASE_INSENSITIVE), "Siam"),
			new PatternName(Pattern.compile("Irk.{0,4}", Pattern.CASE_INSENSITIVE), "Irkutsk"),
			...
			new PatternName(Pattern.compile("BR.{0,4}", Pattern.CASE_INSENSITIVE), "Brazil"),
