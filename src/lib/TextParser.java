...
public class TextParser {
	...
	public static PatternName [] patterns = {
			...
			new PatternName(Pattern.compile("(E\\sUS.{0,11})|(E\\sUn.{0,11}|(East\\sUS.{0,11})|(East\\sUn.{0,11}))", Pattern.CASE_INSENSITIVE), "E United States"),
			new PatternName(Pattern.compile("(W\\sUS.{0,11})|(W\\sUn.{0,11})|(West\\sUS.{0,11})|(West\\sUn.{0,11})", Pattern.CASE_INSENSITIVE), "W United States"),
			new PatternName(Pattern.compile("CE.{0,7}A.{0,6}|CA|(C\\sAM.{0,5})", Pattern.CASE_INSENSITIVE), "Central America"),
			...
			new PatternName(Pattern.compile("(UK.{0,2}A.{0,3})|UKR|UA", Pattern.CASE_INSENSITIVE), "Ukraine"),
